...
const NavigationMenu = React.forwardRef(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      "relative z-10 text-card-foreground flex max-w-max flex-1 items-center justify-center",
      className
    )}
    {...props}>
    {children}
...
const NavigationMenuItem = React.forwardRef(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Item
    ref={ref}
    className={cn(
      "flex px-6 font-normal text-xl leading-7 transition-colors hover:opacity-70 hover:text-secondary-foreground/80  focus:text-secondary-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50",
      className
    )}
    {...props}>
    {children}
...
const NavigationMenuViewport = React.forwardRef(({ className, ...props }, ref) => (
  <div className={cn("relative text-card-foreground -left-[23%] -top-1 flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "origin-top-left fixed text-card-foreground m-10 h-[var(--radix-navigation-menu-viewport-height)] overflow-hidden bg-muted/50 shadow data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-75 data-[state=open]:zoom-in-75 md:w-[var(--radix-navigation-menu-viewport-width)]",
        className
      )}
      ref={ref}
      {...props} />
